/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7369b7500c8dd015ddb74ff5339996f1)
// Runtime types generated with workerd@1.20260710.1 2026-07-16 nodejs_compat
interface __BaseEnv_Env {
	CLOUT_SOURCES: R2Bucket;
	CLOUT_PACKAGES: R2Bucket;
	CLOUT_RECEIPTS: R2Bucket;
	CLOUT_PUBLIC: R2Bucket;
	CLOUT_DB: D1Database;
	CLOUT_INGEST_QUEUE: Queue;
	CLOUT_CLASSIFY_QUEUE: Queue;
	CLOUT_SCORE_QUEUE: Queue;
	CLOUT_COMPILE_QUEUE: Queue;
	CLOUT_RECEIPT_QUEUE: Queue;
	CLOUT_NOTIFY_QUEUE: Queue;
	CLOUT_DEADLETTER_QUEUE: Queue;
	CLOUT_ENVIRONMENT: "preview" | "production";
	CLOUT_ALLOWED_ORIGINS: "http://localhost:3000,https://clout-chaser-public.vercel.app" | "https://clout.prime88.studio,http://localhost:3000";
	CLOUT_OPERATOR_TOKEN: string;
	CLOUT_WHOP_WEBHOOK_SECRET: string;
	OPPORTUNITY_SESSION: DurableObjectNamespace<import("./src/index").OpportunitySession>;
	CREATE_OPPORTUNITY_WORKFLOW: Workflow<Parameters<import("./src/index").CreateOpportunityWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OpportunitySession";
	}
	interface PreviewEnv {
		...
		CLOUT_NOTIFY_QUEUE: Queue;
		CLOUT_DEADLETTER_QUEUE: Queue;
		CLOUT_ENVIRONMENT: "preview";
		CLOUT_ALLOWED_ORIGINS: "http://localhost:3000,https://clout-chaser-public.vercel.app";
		CLOUT_OPERATOR_TOKEN: string;
		CLOUT_WHOP_WEBHOOK_SECRET: string;
		OPPORTUNITY_SESSION: DurableObjectNamespace<import("./src/index").OpportunitySession>;
		CREATE_OPPORTUNITY_WORKFLOW: Workflow<Parameters<import("./src/index").CreateOpportunityWorkflow['run']>[0]['payload']>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUT_ENVIRONMENT" | "CLOUT_ALLOWED_ORIGINS" | "CLOUT_OPERATOR_TOKEN" | "CLOUT_WHOP_WEBHOOK_SECRET">> {}
}
